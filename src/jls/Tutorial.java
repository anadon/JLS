...
/**
 * Display tutorial. Also used to display the text that accompanies a demo in
 * the Applet version.
 * 
...
public class Tutorial extends JDialog {
	 ...
	 * @param name
	 *            The name of the html file for the demo.
	 * @param isDemo
	 *            False if tutorial, true if an Applet verson demo.
	 */
