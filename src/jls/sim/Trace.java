...
public class Trace extends JPanel implements MouseListener, MouseMotionListener {
	 ...
	 * 
	 * @param name
	 *            The name of the element being traced (watched).
	 * @param el
	 *            The element this trace is of.
	 * @param bits
	 *            The number of bits in the element being traced.
	 * @param width
	 *            The current width of the trace area.
	 * @param parent
	 ...
	 * @param when
	 *            The time at which the value occurred.
	 */
		...
		while (pos > 0) {
			...
			if (bits > 1) {
				...
				if (!change.value.equals(previousVal)) {
					...
					if (strlen <= rlen) {
						g.drawString(val,
								rpos - rlen + (rlen - strlen) / 2 + 1, baseline);
					}
				}
			}
	 ...
	 * 
	 * @param width
	 *            The new width of the trace window.
	 */
	 ...
	 * 
	 * @param event
	 *            The event object containing the position of the mouse.
	 */
	 ...
	 * 
	 * @param event
	 *            The MouseEvent for the movement.
	 */
