...
/**
 * Keeps track of all wires and wire ends in a "net", which is a multi-segment
 * wire, possibly with branches (a DAG).
 * 
...
public class WireNet {
	...
	// properties
	private Set<WireEnd> ends = new HashSet<WireEnd>(); // the wire ends in this
														// net
	...
	/**
	 * Make a copy of this element. Wirenets are not copied.
	 * 
	...
	/**
	 * Create a new wire net containing a given wire end (that must be in this
	 * net).
	 * 
	 * @param wire
	 *            The wire end that is part of the new net.
	 * 
	...
	/**
	 * Get the number of bits in this wire net. (0 implies the net is not
	 * connected to any elements yet)
	 * 
	 ...
	 * attached element is deleted. If no longer attached to some output, reset
	 * hasinput. Reset bits to max of whatever net is connected to (i.e., will
	 * become 0 if only connected to a variable-bit element like a constant).
	 * Reset tristate to false if no longer connected to a tristate. If no
	 * longer tristate, fix any attached elements.
	 */
	public void recheck() {
	...
	/**
	 * See if more than one wire or wire end from this net overlaps with wire
	 * ends from another net.
	 * 
	 * @param other
	 *            The other wire net.
	 * 
	...
	/**
	 * Make this wire net tri-state or not. Also change any attached elements.
	 * 
	 * @param which
	 *            True to make it tri-state, false to make it not.
	 */
	...
	/**
	 * Set the value on this net. Should only be used by initSim.
	 * 
	 * @param value
	 *            The value.
	 */
	 ...
	 *            The current time.
	 * @param sim
	 *            The simulator object to post events to.
	 */
