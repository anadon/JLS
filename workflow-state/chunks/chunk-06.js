export const meta = {
  name: 'fix-chunk-06',
  description: 'Fix chunk 06/9: apply reviews to issues 797-819 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 797-819', model: 'sonnet' }],
}

const ISSUES = [797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 819]
