export const meta = {
  name: 'fix-chunk-01',
  description: 'Fix chunk 01/9: apply reviews to issues 680-702 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 680-702', model: 'sonnet' }],
}

const ISSUES = [680, 681, 682, 683, 684, 685, 686, 687, 688, 689, 690, 691, 692, 693, 694, 695, 696, 697, 698, 699, 700, 701, 702]
