...
/**
 * Generate test inputs from a file. This is used only in batch mode as a
 * replacement for a signal generator. It cannot be created by the editor.
 * 
...
public class TestGen extends SigSim {
	...
	protected void specError(String msg) {
		...
		if (JLSInfo.batch && JLSInfo.frame == null && !JLSInfo.isApplet) {
			...
			JOptionPane.showMessageDialog(JLSInfo.frame, "error in test file: "
					+ msg);
			return;
		}
