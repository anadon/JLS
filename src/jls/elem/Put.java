...
/**
 * Superclass for input and output points. Contains common data and methods.
 * 
...
public abstract class Put {
	 ...
	 * 
	 * @param name
	 *            The name of this put (e.g., "input0").
	 * @param element
	 *            The element this put is part of.
	 * @param xr
	 *            The x-coordinate of the center of the put relative to the
	 *            upper left corner of the element this put is in.
	 * @param yr
	 *            The y-coordinate of the center of the put relative to the
	 *            upper left corner of the element this put is in.
	 * @param bits
	...
	/**
	 * Record that this put is attached to a WireEnd. Wire end can be null,
	 * indicating that the put is to become unattached.
	 * 
	 * @param end
	 *            The wire end it is to attach to, or null if detaching.
	 */
