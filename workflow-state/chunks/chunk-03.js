export const meta = {
  name: 'fix-chunk-03',
  description: 'Fix chunk 03/9: apply reviews to issues 726-750 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 726-750', model: 'sonnet' }],
}

const ISSUES = [726, 728, 729, 730, 731, 732, 733, 734, 735, 737, 738, 739, 740, 741, 742, 743, 744, 745, 746, 747, 748, 749, 750]
