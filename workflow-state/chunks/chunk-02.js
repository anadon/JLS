export const meta = {
  name: 'fix-chunk-02',
  description: 'Fix chunk 02/9: apply reviews to issues 703-725 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 703-725', model: 'sonnet' }],
}

const ISSUES = [703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 718, 719, 720, 721, 722, 723, 724, 725]
