...
import jls.Circuit;
import jls.JLSInfo;
import jls.sim.Reacts;
import jls.sim.Simulator;

/**
 * Superclass for active elements. Contains common data and methods.
 * 
...
public abstract class LogicElement extends Element implements Reacts {
	...
	/**
	 * Set value (in load context). Need to grab x and y in order to snap
	 * correctly.
	 * 
	 * @param name
	...
	/**
	 * Save current coordinates of this element and all attached wire ends in
	 * case move doesn't work.
	 */
	...
	/**
	 * Restore saved coordinates of this element and all attached wire ends when
	 * move doesn't work.
	 */
	...
	/**
	 * Remove this element from the circuit. Unattaches from all wire nets.
	 * Forces wire nets it disconnects from to recheck their information.
	 * 
	 * @param circuit
	 *            The circuit it is being removed from.
	 */
	...
	/**
	 * Find input or output in this element that a given x,y is close to (if
	 * any). Clears all touching flags. Close is less than JLSInfo.spacing/2 in
	 * any direction.
	 * 
	 * @param x
	 ...
	 * 
	 * @return the input or output that the given coordinates are close to, or
	 *         null if not close to any in this element.
	 */
	...
	/**
	 * Detach from all connections. Delete all inputs and outputs, getting ready
	 * to init all over again.
	 */
	...
	/**
	 * Get the name of this element. Overridden in elements that have names.
	 */
	...
	/**
	 * Get the fully qualified name of this element, in the form sub1.sub2.elem,
	 * where sub1, sub2, etc. are subcircuit names and elem is the element name.
	 * 
	...
	/**
	 * For elements that don't react. Overridden by most elements.
	 */
