...
/**
 * Compresses a single file from standard input to standard ouput into the .xz
 * file format.
 * <p>
 * One optional argument is supported: LZMA2 preset level which is an integer in
