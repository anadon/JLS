export const meta = {
  name: 'fix-chunk-07',
  description: 'Fix chunk 07/9: apply reviews to issues 820-842 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 820-842', model: 'sonnet' }],
}

const ISSUES = [820, 821, 822, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842]
