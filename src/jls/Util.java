...
public final class Util {
	 ...
	 * 
	 * @param button
	 *            The button to put the listener on.
	 */
	...
	/**
	 * Check to make sure a name (string) consists only of letters, digits and
	 * underscore, is at least one character long, and starts with a letter.
	 * 
	 * @param str
	 *            The string to check.
	 * 
	...
	/**
	 * Check for a valid circuit file name. A valid name can be a path name
	 * (with slashes or backslashes), but the actual file name must be a valid
	 * name as defined by isValidName. Any character in the string before the
	 * last slash/backslash is valid.
	 * 
	 * @param str
	 *            The string to check.
	 * 
	 * @return the base name (minus directory prefix) if valid, or null if not
	 *         valid.
	 */
	 ...
	 *            The base.
	 * @param True
	 *            if prefix or suffix needed, false if not.
	 * 
	 * @return the string.
	 */
