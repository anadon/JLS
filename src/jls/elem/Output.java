...
/**
 * Output point on an element. WireEnds connect to these.
 * 
...
public class Output extends Put {
	 ...
	 * @param element
	 *            The element it is part of.
	 * @param xr
	 *            The x-coordinate of the center of the output relative the
	 *            upper left corner of the element this put is in.
	 * @param yr
	 *            The y-coordinate of the center of the output relative the
	 *            upper left corner of the element this put is in.
	 * @param bits
	 *            The number of bits in the output. 0 implies an arbitrary
	 *            number.
	 */
	 ...
	 * 
	 * @param element
	 *            The element this output will be part of.
	 * 
	 * @return A copy.
	 */
	...
	/**
	 * Make this output be tri-state or not. Propagate to an attached wire, if
	 * one.
	 * 
	 * @param which
	 *            True to make this output be tri-state, false otherwise.
	 */
	 ...
	 * Should only be used by initSim. Does not make a copy, so make sure value
	 * does not change.
	 * 
	 * @param value
	 *            The value.
	...
	/**
	 * Send value to all inputs connected to this output. Value not sent if it
	 * is the same as the current output value. Current value of this output
	 * saved. Uses wire net to do the work.
	 * 
	 * @param value
	 *            The value to send.
	 * @param now
