...
<!--
  ...
  HL  HORIZON LENGTH — the DEPENDENT-step chain, in expert time, from a
      ...
      This is an expectation, never a bound: score the chain you actually
      see. A feature whose children have landed and whose integration is
      one scripted check is genuinely short work and scores 4-5. A feature
      whose integration must reconcile contracts across several children
      scores low, and that is the tier working as designed.
      ...
      has not landed, score the integration as it will be once it has, and
      say so in the prose line. Do not inflate it and do not read it as
