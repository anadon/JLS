 ...
 * <p>
 * It is possible to specify a memory usage limit for <code>XZInputStream</code>
 * . If decompression requires more memory than the specified limit,
 * MemoryLimitException will be thrown when reading from the stream. For
 * example, the following sets the memory usage limit to 100&nbsp;MiB:
 * <p>
 * <blockquote>
 * 
 * <pre>
