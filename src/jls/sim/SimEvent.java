...
public final class SimEvent implements Comparable<SimEvent> {
	 ...
	 * @param callBack
	 *            The object to tell when the event occurs.
	 * @param todo
	 *            An object containing information about what the reacting
	 *            object should do about this event. Null typically means an
	 *            input pin has changed value.
	 */
	...
	/**
	 * Compares this SimEvent with another. Only the time and seq is used since
	 * compareTo is only used by the event queue.
	 * 
	 * @param other
	 *            The object to compare this one with.
	 * 
	 * @return -1 if this object's time/seq is less than other's, 0 if the
	 *         times/seqs are equal, and +1 if this object's time/seq is greater
	 *         than other's.
	 */
	...
	/**
	 * Decide whether this JLSEvent object and another are equal. They will be
	 * equal if the have the same time, the same callback object, and the same
	 * todo object.
	 * 
	 * @param other
	 *            The object to compare this one with.
	...
	public boolean equals(Object other) {
		...
		if (this.callBack != oth.callBack)
			return false;
		return this.todo == null ? oth.todo == null : this.todo
				.equals(oth.todo);
	} // end of equals method

	/**
	 * Return a hash code for this object. This must be consistent with the
	 * equals method, hence objects that are equal will have the same hash code.
