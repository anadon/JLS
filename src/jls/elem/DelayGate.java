...
/**
 * Delay gate. Logically neutral, simply delays a signal change by a given
 * amount.
 * 
...
public class DelayGate extends Gate {
	 ...
	 * 
	 * @param circuit
	 *            The circuit this DELAY gate is in.
	 */
	...
	private class DelayCreate extends JDialog implements ActionListener {
		...
		private KeyPad delayPad = new KeyPad(delayField, 10, defaultPropDelay,
				this);
