export const meta = {
  name: 'fix-chunk-08',
  description: 'Fix chunk 08/9: apply reviews to issues 843-865 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 843-865', model: 'sonnet' }],
}

const ISSUES = [843, 844, 845, 846, 847, 848, 849, 850, 851, 852, 853, 854, 855, 856, 857, 858, 859, 860, 861, 862, 863, 864, 865]
