...
public abstract class SeekableInputStream extends InputStream {
	 ...
	 * conflict with the specification of {@link java.io.InputStream#skip(long)
	 * InputStream.skip}.
	 * 
	 * @return <code>0</code> if <code>n</code> is negative, less than
	 *         <code>n</code> if skipping <code>n</code> bytes would seek past
	 *         the end of the file, <code>n</code> otherwise
	 * 
	 * @throws IOException
	 ...
	 * 
	 * @throws IOException
	 *             if <code>pos</code> is negative or if a stream-specific I/O
	 *             error occurs
	 */
