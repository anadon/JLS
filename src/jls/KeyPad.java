...
public class KeyPad extends JButton implements ActionListener {
	 ...
	 * 
	 * @param target
	 *            The text field the keypad will fill.
	 * @param digitKeys
	 *            The number of digits in the keypad (10 or 16 only);
	 * @param defaultValue
	 *            The default value for this field.
	 * @param f
	 *            The window this is in.
	 */
	public KeyPad(JTextField target, int digitKeys, long defaultValue,
			final Window f) {
	...
	/**
	 * Change the base. Will not change the appearance of the keypad, but will
	 * change what digits are allowed.
	 * 
	 * @param base
	 *            The new base.
	 */
	...
	/**
	 * Value has been reset, so remember that any change will be the first
	 * change.
	 */
	public void reset() {
