...
/**
 * Input point on an element. WireEnds connect to these.
 * 
...
public class Input extends Put {
	 ...
	 * @param xr
	 *            The x-coordinate of the center of the input relative to the
	 *            upper left corner of the element it is in.
	 * @param yr
	 *            The y-coordinate of the center of the input relative to the
	 *            upper left corner of the element it is in.
	 * @param bits
	 ...
	 * 
	 * @param element
	 *            The element this input will be part of.
	 * 
	 * @return A copy.
	 */
