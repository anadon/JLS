...
public final class BitSetUtils {
	 ...
	 * @param radix
	 *            The radix to convert the BitSet to.
	 * 
	...
	/**
	 * Convert a BitSet to a string representation in base 10 assuming two's
	 * complement.
	 * 
	 * @param bs
	 *            The BitSet to convert.
	 ...
	 * 
	 * @param carryIn
	 *            The carry in to the lower order bit position.
	 * @param bs1
	 *            One operand.
	 * @param bs2
	 *            Another operand.
	...
	/**
	 * Convert a bitset into displayable values (hex,unsigned,signed). A null
	 * bitset is converted to "HiZ".
	 * 
	 * @param value
	 *            The BitSet.
	 * @param bits
