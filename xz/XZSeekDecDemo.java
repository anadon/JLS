 ...
 * <p>
 * If one or more of the offset-length pairs are given, for each pair,
 * <code>length</code> number of bytes are decompressed from <code>offset</code>.
 */
class XZSeekDecDemo {
	public static void main(String[] args) throws Exception {
		...
		System.err.println("Largest XZ Block size: " + in.getLargestBlockSize()
				+ " B");
		...
		System.err.println("Index memory usage: " + in.getIndexMemoryUsage()
				+ " KiB");
