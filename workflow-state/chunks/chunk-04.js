export const meta = {
  name: 'fix-chunk-04',
  description: 'Fix chunk 04/9: apply reviews to issues 751-773 (23 issues)',
  phases: [{ title: 'Fix', detail: 'issues 751-773', model: 'sonnet' }],
}

const ISSUES = [751, 752, 753, 754, 755, 756, 757, 758, 759, 760, 761, 762, 763, 764, 765, 766, 767, 768, 769, 770, 771, 772, 773]
