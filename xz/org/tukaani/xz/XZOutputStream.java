...
public class XZOutputStream extends FinishableOutputStream {
	 ...
	 * 
	 * @throws UnsupportedOptionsException
	 *             unsupported filter chain, or trying to change the filter
	 *             chain in the middle of a Block
	 */
	 ...
	 * 
	 * @throws XZIOException
	 *             <code>finish()</code> or <code>close()</code> was already
	 *             called
	 * 
	 * @throws IOException
	 *             may be thrown by the underlying output stream
	 */
	 ...
	 * 
	 * @throws XZIOException
	 *             XZ Stream has grown too big: total file size about 8&nbsp;EiB
	 *             or the Index field exceeds 16&nbsp;GiB; you shouldn't reach
