...
/**
 * Display the truth table. Uses an array of Entry sub-objects.
 * 
...
public final class Display extends JPanel implements MouseListener {
	 ...
	 * 
	 * @param ttelem
	 *            The truth table element this is a part of.
	 */
	 ...
	 * 
	 * @param g
	 *            The Graphics object to print with.
	 */
	...
	/**
	 * Set the positions of all entries. Uses minimum sizes of all entries to
	 * make all rows and columns line up.
	 * 
	 * @param ins
	 *            The input signal names.
	 * @param outs
	 *            The output signal names.
	 * @param table
	 *            The input and output values.
	 * @param g
	 *            A Graphics object to use. If null, get this object's Graphics
	 *            object.
	 */
	public void doLayout(Vector<String> ins, Vector<String> outs,
			int[][] table, Graphics g) {
	...
	/**
	 * React to mouse pressed events. Find entry under mouse and do the
	 * appropriate action depending on the type of the entry.
	 * 
	 * @param event
	 *            The event object.
	 */
