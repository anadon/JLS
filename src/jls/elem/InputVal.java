...
/**
 * Draw an input signal value and react to value being clicked on in the truth
 * table.
 * 
...
public final class InputVal extends Entry {
	 ...
	 * @param value
	 *            The value of this signal in this place.
	 * @param g
	 *            A Graphics object to size the value with.
	 */
	...
	public void draw(Graphics g) {
		...
		g.drawString(str, x + (this.width - width) / 2, y
				+ (this.height - height) / 2 + ascent);
	} // end of draw method

	/**
	 * Change value when selected. A 0 or 1 becomes a don't care (if possible)
	 * and two rows are collapsed. A don't care expands into two rows.
	 * 
	 * @param row
	 *            The row this entry is in.
	 * @param col
	 *            The column this entry is in.
	 */
