...
/**
 * Draw an output signal name, display menu when one is clicked on, and react to
 * menu choices.
 * 
...
public final class OutputSig extends Entry implements ActionListener {
	 ...
	 * @param g
	 *            A Graphics object to size the name with.
	 */
	...
	public void draw(Graphics g) {
		...
		g.drawString(signal, x + (this.width - width) / 2, y
