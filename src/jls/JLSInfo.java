...
public final class JLSInfo {
	...
	public static final String build = "<p>[built on October 22th, 2012 at 12:00 PM]";
	...
	public static final int circuitsize = 1000; // square circuit (can be
												// increased)
	...
	public static final Color touchColor = Color.green; // when connections line
														// up
	public static final Color highlightColor = Color.pink; // when elements are
															// highlighted
	public static final Color selectionColor = new Color(240, 240, 240); // when
																			// elements
																			// are
																			// selected
	public static final Color watchColor = Color.cyan; // watched elements
	public static final Color nonZeroColor = Color.red; // wires with non-zero
														// values
	public static final Color initialStateColor = Color.lightGray; // initial
																	// states of
																	// state
																	// machines
	public static final int checkPointFreq = 10; // how many changes between
													// checkpoint file writes
	public static final int undoStackDepth = 10; // maximum number of undos
	public static final long defaultTimeLimit = 100000000; // default simulation
															// time
	...
	public static Color gridColor = new Color(240, 240, 240); // editor window
																// grid
