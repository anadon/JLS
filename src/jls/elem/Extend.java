	...
	public boolean setup(Graphics g, JPanel editWindow, int x, int y) {
		...
		if (ok && bits < 2) {
			JOptionPane.showMessageDialog(JLSInfo.frame,
					"must have at least 2 bits of output");
			return false;
		}
