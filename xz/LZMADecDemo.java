...
/**
 * Decompresses .lzma files to standard output. If no arguments are given, reads
 * from standard input.
 * 
 * NOTE: For most purposes, .lzma is a legacy format and usually you should use
 * .xz instead.
 */
class LZMADecDemo {
	public static void main(String[] args) {
		...
		try {
			...
			System.err.println("LZMADecDemo: Error decompressing from " + name
					+ ": " + e.getMessage());
			System.exit(1);
		}
	}
