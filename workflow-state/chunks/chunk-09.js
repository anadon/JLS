export const meta = {
  name: 'fix-chunk-09',
  description: 'Fix chunk 09/9: apply reviews to issues 866-889 (19 issues)',
  phases: [{ title: 'Fix', detail: 'issues 866-889', model: 'sonnet' }],
}

const ISSUES = [866, 867, 868, 872, 873, 874, 875, 876, 877, 878, 879, 880, 882, 883, 884, 885, 886, 888, 889]
