...
public class WireEnd extends LogicElement {
	...
	private Set<Wire> wires = new HashSet<Wire>(); // the wires it is connected
													// to
	 ...
	 * 
	 * @param circuit
	 *            The circuit the wire end is in.
	 */
	 ...
	 * 
	 * @param The
	 *            Graphics object needed by overridden methods.
	 */
	 ...
	 * 
	 * @param circ
	 *            The circuit this wire end is in.
	 */
	...
	/**
	 * See if the element is completely inside a given rectangle. In this case
	 * only the center point needs to be inside the given rectangle.
	 * 
	 * @param rect
	 *            The given rectangle.
	 * 
	...
	/**
	 * Remove a wire from this wire end. If last wire removed, remove this wire
	 * end too.
	 * 
	 * @param wire
	 *            The wire to remove.
	 * @param circ
	 *            The circuit the wire is in.
	 */
		...
		if (wires.isEmpty()) {
			...
			if (isAttached()) {
				if (this.getPut() instanceof Output) {
					...
					put = null;
				} else if (getNet().isTriState()
						&& put.getElement() instanceof TriProp) {
	 ...
	 * 
	 * @param which
	 *            True to make it tri-state, false otherwise.
	 */
	...
	/**
	 * See if this wire end is dangling (i.e., has at most one wire and is not
	 * attached).
	 * 
	...
	/**
	 * Get wire this wire end is connected to, or null if no connection. Assumes
	 * that there is only one (i.e., that this is a dangling end).
	 * 
	 ...
	 * 
	 * @param id
	 *            The id of the other end of the wire.
	 * @param name
	 *            The probe name.
	 */
